...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		...
		"./factory.js": 13,
		"./filters.js": 14,
		"./imSelect/imSelect.js": 15,
		"./templates/imLocationDir.js": 21
	};
...
/***/ function(module, exports) {
	...
	(function () {
	  ...
	  angular.module('documentarioApp', ['ngAnimate', 'ngCookies',
	  // 'ngFileUpload',
	  'ngFileUpload', 'ngResource', 'ngRoute', 'ngSanitize', 'adaptv.adaptStrap', 'mgcrea.ngStrap', 'doc.features', 'ui.select', 'ui.bootstrap', "highcharts-ng", "bootstrapLightbox"]);
	  angular.module('doc.features', []).constant("ServicesConfig", {
	    "url": "phpserverv1"
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  angular.module('doc.features').directive('datePicker', function () {
	    return {
	      restrict: 'A',
	    ...
	    return {
	      ...
	      controller: ['$scope', '$location', function ($scope, $location) {
	        ...
	        // Select current path
	        vm.mainMenu.some(function (menu) {
	          var isRouteActive = menu.subMenu.some(function (item) {
	        ...
	        vm.onClickSubMenu = function (menu, item) {
	          menu.forEach(function (subItem) {
...
/***/ function(module, exports) {
	...
	module.exports = "<!-- sidebar menu: : style can be found in sidebar.less -->\n<ul class=\"sidebar-menu\">\n    <li class=\"header\">MENÚ PRINCIPAL</li>\n    <li ng-repeat=\"menu in mainMenu\"\n        ng-if=\"menu.isAllowed\"\n        ng-click=\"onClickSubMenu(mainMenu, menu)\"\n        ng-class=\"{active: menu.isActive}\"\n        class=\"{{menu.liClass}}\">\n        <a ng-href=\"{{menu.aLink}}\">\n            <i class=\"{{menu.aIcon}}\"></i> \n            <span>{{menu.aText}}</span> \n            <i ng-if=\"menu.subMenu.length > 0 \"\n               class=\"fa fa-angle-left pull-right\"></i>\n        </a>\n        <ul ng-if=\"menu.subMenu.length > 0\"\n            class=\"treeview-menu\">\n            <li ng-repeat=\"item in menu.subMenu\" \n                ng-if=\"item.isAllowed\"\n                ng-class=\"{active: item.isActive}\"\n                ng-click=\"onClickSubMenu(menu.subMenu, item)\">\n                <a ng-href=\"{{item.aLink}}\">\n                    <i class=\"{{item.aIcon}}\"></i> {{item.aText}}\n                </a>\n            </li>\n        </ul>\n    </li>\n</ul>"

/***/ },
/* 7 */
/***/ function(module, exports) {

	module.exports = "<div class=\"user-panel\">\n    <div class=\"pull-left info\">\n        <div ng-switch=\"currentUser.role_id\">\n            <strong>::: Web Calidad </strong>\n        </div>\n    </div>\n</div>"

/***/ },
/* 8 */
/***/ function(module, exports) {

	module.exports = "<ui-select multiple\n           class=\"col-sm-10\"\n           theme=\"bootstrap\"\n           ng-model=\"selection\"\n           data-close-on-select=\"false\"\n           data-on-select=\"clearSelection($select)\"\n           data-on-remove=\"removeTag($item)\">\n    <ui-select-match placeholder=\"{{placeholder}}\">{{$item}}</ui-select-match>\n    <ui-select-choices repeat=\"item in getTags($select.search) | filter:$select.search\">\n        <span ng-bind-html=\"item | highlight: $select.search\"></span>\n    </ui-select-choices>\n</ui-select>"

/***/ },
/* 9 */
/***/ function(module, exports) {

	module.exports = "<div class=\"box\">\n    <div class=\"form-group\">\n        <label class=\"col-sm-3 control-label\">Nombre de Receptor por M.P.:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ document.created_by_name }}</p>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label class=\"col-sm-3 control-label\">Fecha de Recepción por M.P.:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ document.created_at }}</p>\n        </div>\n    </div>\n    <div class=\"form-group\"\n            ng-if=\"!!document.updated_by\">\n        <label class=\"col-sm-3 control-label\">Última actualización por:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ document.updated_by_name }}</p>\n        </div>\n    </div>\n    <div class=\"form-group\"\n            ng-if=\"!!document.updated_by\">\n        <label class=\"col-sm-3 control-label\">Fecha de última actualización:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ document.updated_at }}</p>\n        </div>\n    </div>\n</div>"

/***/ },
/* 10 */
/***/ function(module, exports) {

	module.exports = "<div class=\"box\">\n    <div class=\"form-group\">\n        <label class=\"col-sm-3 control-label\">Asignado a:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ assignment.created_by_name }}</p>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label class=\"col-sm-3 control-label\">Fecha de asignación:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ assignment.created_at }}</p>\n        </div>\n    </div>\n</div>"

/***/ },
/* 11 */
/***/ function(module, exports) {

	module.exports = "<div class=\"box\">\n    <div class=\"form-group\">\n        <label class=\"col-sm-3 control-label\">Nombre de Recepcionado c/cargo:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ discharge.f_description }}</p>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label class=\"col-sm-3 control-label\">Fecha de Recepción c/cargo:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ discharge.created_at }}</p>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label class=\"col-sm-3 control-label\">Observación:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ discharge.s_description }}</p>\n        </div>\n    </div>\n</div>"

/***/ },
/* 12 */
/***/ function(module, exports) {

	module.exports = "<div class=\"box\">\n    <div class=\"form-group\">\n        <label class=\"col-sm-2 control-label\">Nombre de Recepcionado Usuario:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ closed.created_by_name }}</p>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label class=\"col-sm-2 control-label\">Fecha de Recepción Usuario:</label>\n        <div class=\"col-sm-6\">\n            <p class=\"form-control-static\">{{ closed.created_at }}</p>\n        </div>\n    </div>\n</div>"
...
/***/ function(module, exports) {
	...
	.factory('notification', ['$alert', function ($alert) {
	  return {
	    ...
	    genericErrorHandler: function genericErrorHandler(response) {
	      $alert({
	  ...
	  CurrentUser.prototype.isAllowed = function (table, permission) {
	    ...
	    return this.restrictions && this.restrictions[table] && this.restrictions[table][permission] && this.restrictions[table][permission] === 1;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('doc.features').directive('imSelect', function () {
	  return {
	    restrict: 'E',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js!./imSelect.scss", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js!./imSelect.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "ad-infinite-dropdown button {\n  width: 100%;\n  text-align: left !important; }\n  ad-infinite-dropdown button.btn-default {\n    background: #FFF; }\n\nad-infinite-dropdown .caret {\n  margin-top: 8px;\n  float: right; }\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "<ad-infinite-dropdown dropdown-name=\"{{ajaxConfig.name}}\"\n                display-property=\"{{ajaxConfig.displayProperty}}\"\n                initial-label=\"{{ajaxConfig.initialText}}\"\n                selected-items=\"ajaxConfig.selectedItem\"\n                max-height=\"300px\"\n                max-width=\"500px\"\n                single-selection-mode=\"true\"\n                dropdown-status=\"ajaxConfig.dropdownStatus\"\n                label-display-property=\"{{ajaxConfig.displayProperty}}\"\n                on-item-click=\"ajaxConfig.onSelectItem\"\n                dropdown-header-template-url=\"core/imSelect/customSearch.html\"\n                on-data-loaded=\"dlc($success, $response)\"\n                ajax-config=\"ajaxConfig\">\n</ad-infinite-dropdown>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('doc.features').directive('imLocation', function () {
	  return {
	    restrict: 'E',
	    ...
	    controller: ['$scope', 'Ubigeo', function ($scope, Ubigeo) {
	      var vm = $scope;
	      ...
	      function getCode() {
	        ...
	        if (vm.locationData.dpto) {
	          ...
	          result += vm.locationData.prov ? vm.locationData.prov < 10 ? '0' + vm.locationData.prov.toString() : vm.locationData.prov.toString() : '00';
	
	          result += vm.locationData.dist ? vm.locationData.dist < 10 ? '0' + vm.locationData.dist.toString() : vm.locationData.dist.toString() : '00';
	        }
	
	        return result;
	      }
	
	      Ubigeo.query({}, function (response) {
	      ...
	      vm.showDistritos = function () {
	        vm.distritos = Ubigeo.query(vm.locationData);
	        vm.ubigeoSelected = getCode();
	        vm.onChange({ data: getCode() });
	      };
	
	      vm.onSelectLocation = function () {
	        vm.ubigeoSelected = getCode();
	        vm.onChange({ data: getCode() });
	      };
	    }]
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js!./imLocationDir.scss", function() {
				var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/sass-loader/index.js!./imLocationDir.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".im-location-wrap select {\n  width: 200px; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./comments/comments.component.js": 25,
		"./contenidos/content-form/content.component.js": 28,
		"./contenidos/content-form/content.service.js": 30,
		"./contenidos/content-list/content-list.component.js": 31,
		"./contenidos/graphic-field/graphic-field.component.js": 35,
		"./exportador/exportador.component.js": 37,
		"./generador/comment-block/comment-block.component.js": 39,
		"./generador/comment-block/comment.service.js": 41,
		"./generador/comment-popup/comment-popup.component.js": 42,
		"./generador/content-link/content-link.component.js": 44,
		"./generador/generador/generador.component.js": 46,
		"./generador/generador/generator.service.js": 48,
		"./generador/graphic/graphic.component.js": 49,
		"./generador/image-list/image-list.component.js": 51,
		"./generador/report-menu/report-menu.component.js": 53,
		"./generador/tabla/tabla.component.js": 55,
		"./general/generalCtrl.js": 57,
		"./reportes/reportes-form/reportes-form.component.js": 60,
		"./reportes/reportes.component.js": 62,
		"./reportes/reportes.service.js": 66,
		"./routes.js": 67
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function Controller(CommentSvc, ServicesConfig) {
	    var vm = this;
	    vm.searchKey = '';
	    vm.toDelete = {
	        ID: 0,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentCtrl = function ContentCtrl(notification, ServicesConfig, ContentSvc, $routeParams, ReportesSvc, $location, $q) {
	  ...
	  vm.backToList = function () {
	    return $location.path('/contenidos');
	  };
	
	  var reportPromise = ReportesSvc.query(function (response) {
	  ...
	  vm.updateSubReportList = function (report_id) {
	    vm.subreports = vm.reports.find(function (report) {
	  ...
	  vm.addGraph = function () {
	    ...
	    ContentSvc.verifyKpis({
	      ...
	      vm.kpis = response.results.map(function (item, index) {
	        return {
	  ...
	  vm.removeGraph = function (index) {
	    return vm.content.graphs.splice(index, 1);
	  };
	  ...
	  $q.all([reportPromise.$promise]).then(function () {
	    ...
	    if (id) {
	      ContentSvc.get({ ID: id }, function (response) {
...
/***/ function(module, exports) {
	...
	angular.module('doc.features').factory('ContentSvc', ['$resource', 'ServicesConfig', function ($resource, ServicesConfig) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContentListCtrl = function ContentListCtrl(notification, ServicesConfig, ContentSvc) {
	    var vm = this;
	    ...
	    vm.delete = function (content_id) {
	        ...
	        ContentSvc.delete({ ID: content_id }, function () {
	            vm.tableConfig.params.reload = !vm.tableConfig.params.reload;
	            notification.great('Eliminado correctamente.');
	        }, function (error) {
	            var message = error.data && error.data.results && error.data.results.message || 'Error al eliminar.';
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"content-header\">\n    <h1>Gestión de Contenidos</h1>\n</div>\n<div class=\"content\">\n    <div class=\"row\">\n        <div class=\"col-sm-4\">\n            <div class=\"text-left\">\n                <a href=\"#/contenidos/create\" type=\"button\" class=\"btn btn-primary\">\n                    <i class=\"fa fa-plus-circle\"></i>\n                    Crear contenido\n                </a>\n            </div>\n        </div>\n    </div>\n    <div class=\"panel panel-default\">\n        <div class=\"panel-heading\">\n            <div class=\"row\">\n                <div class=\"col-sm-4\">\n                    <div class=\"input-group\">\n                        <input type=\"text\"\n                               class=\"form-control\"\n                               placeholder=\"Buscar\"\n                               data-enter-press=\"$ctrl.search()\"\n                               ng-model=\"$ctrl.searchKey\">\n                        <span class=\"input-group-addon\"\n                              ng-click=\"$ctrl.search()\">\n                            <i class=\"glyphicon glyphicon-search\"></i>\n                        </span>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"panel-body\">\n            <ad-table-ajax \n                           column-definition=\"$ctrl.colDef\"\n                           table-classes=\"table table-bordered table-hover bg-blank\"\n                           page-sizes=\"[10, 25, 100]\"\n                           page-size=\"10\"\n                           pagination-btn-group-classes=\"pagination pagination-sm\"\n                           ajax-config=\"$ctrl.tableConfig\"\n                           page-loader=\"methods.pageLoader\"\n                           state=\"$ctrl.tableConfig.state\"\n                           items-not-found-message=\"No se encontraron datos\">\n            </ad-table-ajax>\n        </div>\n    </div>\n</div>\n\n<div class=\"modal fade\"\n     id=\"deleteModal\"\n     tabindex=\"-1\"\n     role=\"dialog\"\n     aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n            <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                <h4 class=\"modal-title\" id=\"myModalLabel\">Confirmar eliminación</h4>\n            </div>\n            <div class=\"modal-body\">\n                Seguro que desea eliminar el Contenido: {{ $ctrl.toDelete.NAME }}\n            </div>\n            <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-primary\" data-dismiss=\"modal\">Cancelar</button>\n                <button type=\"button\"\n                        class=\"btn btn-danger\"\n                        ng-click=\"$ctrl.delete($ctrl.toDelete.ID)\"\n                        data-dismiss=\"modal\">\n                    Eliminar\n                </button>\n            </div>\n        </div>\n    </div>\n</div>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GraphicCtrl = function GraphicCtrl() {
	  var vm = this;
	
	  vm.removeGraph = function () {
	    vm.onRemoveGraphic();
	  };
	
	  vm.addSerie = function () {
	    return vm.graphic.series.push({});
	  };
	  vm.removeSerie = function (index) {
	    return vm.graphic.series.splice(index, 1);
	  };
	
	  vm.updateSubGraphicType = function () {
	    switch (vm.graphic.graphic_type) {
	      case 'pie':
	        vm.graphic.series.forEach(function (serie) {
	          return serie.SUBGRAPHIC_TYPE = '';
	        });
	  ...
	  vm.addYAxis = function () {
	    vm.graphic.yAxises.push({});
	  };
	
	  vm.removeYAxis = function (index) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"form-group\">\n    <div class=\"row\">\n        <label for=\"descripcion\" class=\"col-sm-2 control-label\" required-field>Título: </label>\n        <div class=\"col-sm-8\"> \n            <input type=\"text\" class=\"form-control\" id=\"titulo\" placeholder=\"titulo del grafico\"\n                required\n                maxlength=\"500\"\n                ng-model=\"$ctrl.graphic.title\"\n                data-auto-focus>\n        </div> \n        <div class=\"col-sm-2 pull-right\"> \n            <a  ng-click=\"$ctrl.removeGraph()\"> <i class=\"fa fa-trash\"></i> Borrar Grafico</a>\n        </div>\n     </div>\n</div>\n<div class=\"row\">\n    <div class=\"col-sm-1\">\n        <h5 class=\"box-title\">KPIs: </h5>\n    </div>\n    <div class=\"col-sm-8\">\n       * Se encontraron ({{$ctrl.graphic.kpis.length}}) KPIs en el  StoreProcedure\n    </div>\n</div> \n\n<table class=\"table table-striped\">\n    <tbody>\n        <tr>\n            <th style=\"width: 10px\">#</th>\n            <th>KPI</th>  \n            <th>GRAFICO</th> \n            <th>Etiqueta Y Axis</th> \n            <th>Unidad de Medida</th>  \n            <th>Y Max</th>\n            <th>Y Min</th> \n            <th>Axisa Opuesta</th>\n        </tr>\n        <tr ng-repeat=\"kpi in $ctrl.graphic.kpis\">\n            <td>#</td>\n            <td>{{kpi.NAME_FROM_PROCEDURE}}</td>\n            <td>\n                <select class=\"form-control\" name=\"kpi-tipo\" ng-model=\"kpi.GRAPHIC_TYPE\">\n                    <option value=\"line\">Linea</option>\n                    <option value=\"pie\">Pie</option>\n                    <option value=\"spline\">Spline</option>\n                    <option value=\"column\">Columna</option>\n                    <option value=\"bar\">Bar</option>\n                    <option value=\"area\">Area</option>\n                </select>\n            </td>\n            <td>\n                <input class=\"form-control\" type=\"text\" ng-model=\"kpi.TITLE\" required>\n            </td>\n            <td>\n                <input class=\"form-control\" type=\"text\" ng-model=\"kpi.SUFFIX\" required>\n            </td>\n            <td>\n                <input class=\"form-control\" type=\"text\" ng-model=\"kpi.YMAX\" placeholder=\"Automatico\">\n            </td>\n            <td>\n                <input class=\"form-control\" type=\"text\" ng-model=\"kpi.YMIN\" placeholder=\"Automatico\">\n            </td>\n            <td>\n                <input type=\"checkbox\" ng-model=\"kpi.OPPOSITE\" ng-true-value=\"'1'\" ng-false-value=\"'0'\"> \n            </td>\n        </tr>\n    </tbody>\n</table>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function Controller(GeneradorSvc, $scope) {
	    var vm = this;
	    vm.isLoading = false;
	    vm.filtros = {
	        year: 0,
	    ...
	    vm.updateFiltersFromSemanaSelected = function () {
	        var _vm$semanaSelected$CO = vm.semanaSelected.CODE.split(','),
	            _vm$semanaSelected$CO2 = _slicedToArray(_vm$semanaSelected$CO, 2),
	            year = _vm$semanaSelected$CO2[0],
	            week = _vm$semanaSelected$CO2[1];
	
	        vm.filtros.year = year;
	        vm.filtros.week = week;
	    };
	    vm.semanaListChange = function () {
	        vm.updateFiltersFromSemanaSelected();
	    };
	    GeneradorSvc.getSemanas(function (response) {
	    ...
	    vm.exportContent = function () {
	        ...
	        vm.isLoading = true;
	        GeneradorSvc.getAllContent(vm.filtros, function (response) {
	    ...
	    vm.addReportTitle = function (text) {
	
	        vm.doc.setFontSize(10);
	        vm.doc.text(150, vm.yPosition, 'A\xF1o: ' + vm.filtros.year + ' - Semana: ' + vm.filtros.week);
	    ...
	    vm.addGraphic = function (graphiId) {
	    ...
	    vm.addContentSection = function (contents, reportName, subReportName) {
	        ...
	        contents.forEach(function (content) {
	            ...
	            content.graphics.forEach(function (graphic) {
	                // vm.addGraphicTitle(doc, graphic.title);
	                // add graphic
	                vm.addGraphic(graphic.id);
	                // add comments table
	                var idx = 1;
	                vm.addTable(graphic.comments.map(function (comment) {
	                    return ['\xBB ' + comment.COMENTARIO];
	                }));
	            });
	        });
	    };
	    ...
	    vm.generatePdf = function (reports) {
	        vm.doc = new jsPDF();
	        ...
	        reports.forEach(function (report) {
	            ...
	            report.subreports.forEach(function (subreport) {
	    ...
	    (function (H) {
	        H.Chart.prototype.callbacks.push(function (chart) {
	            ...
	            if (opt.top) chart.watermark.toFront();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function Controller(CommentSvc, $scope, $window, $timeout) {
	    var vm = this;
	    vm.list = [];
	    vm.listComplete = [];
	    vm.listLimit = 3;
	    ...
	    vm.mostrarEditor = function () {
	        ...
	        vm.wEditor = new wysihtml5.Editor('text-editor', { toolbar: "toolbar", parserRules: {
	                ...
	                }, _defineProperty(_tags, 'u', {}), _defineProperty(_tags, "bgsound", {
	                    "remove": 1
	                }), _defineProperty(_tags, "sup", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "address", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "basefont", {
	                    "remove": 1
	                }), _defineProperty(_tags, "nav", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "h1", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "head", {
	                    "remove": 1
	                }), _defineProperty(_tags, "tbody", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "dd", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "s", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "li", {}), _defineProperty(_tags, "td", {
	                    "check_attributes": {
	                        "rowspan": "numbers",
	                        "colspan": "numbers"
	                    },
	                ...
	                }), _defineProperty(_tags, "object", {
	                    "remove": 1
	                }), _defineProperty(_tags, "div", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "option", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "select", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "i", {}), _defineProperty(_tags, "track", {
	                    "remove": 1
	                }), _defineProperty(_tags, "wbr", {
	                    "remove": 1
	                }), _defineProperty(_tags, "fieldset", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "big", {
	                    "rename_tag": "span",
	                    "set_class": "wysiwyg-font-size-larger"
	                }), _defineProperty(_tags, "button", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "noscript", {
	                    "remove": 1
	                }), _defineProperty(_tags, "svg", {
	                    "remove": 1
	                }), _defineProperty(_tags, "input", {
	                    "remove": 1
	                }), _defineProperty(_tags, "table", {}), _defineProperty(_tags, "keygen", {
	                    "remove": 1
	                }), _defineProperty(_tags, "h5", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "meta", {
	                    "remove": 1
	                }), _defineProperty(_tags, "map", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "isindex", {
	                    "remove": 1
	                }), _defineProperty(_tags, "mark", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "caption", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "tfoot", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "base", {
	                    "remove": 1
	                }), _defineProperty(_tags, "video", {
	                    "remove": 1
	                }), _defineProperty(_tags, "strong", {}), _defineProperty(_tags, "canvas", {
	                    "remove": 1
	                }), _defineProperty(_tags, "output", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "marquee", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "b", {}), _defineProperty(_tags, "q", {
	                    "check_attributes": {
	                        "cite": "url"
	                    }
	                }), _defineProperty(_tags, "applet", {
	                    "remove": 1
	                }), _defineProperty(_tags, "span", {}), _defineProperty(_tags, "rp", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "spacer", {
	                    "remove": 1
	                }), _defineProperty(_tags, "source", {
	                    "remove": 1
	                }), _defineProperty(_tags, "aside", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "frame", {
	                    "remove": 1
	                }), _defineProperty(_tags, "section", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "body", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "ol", {}), _defineProperty(_tags, "nobr", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "html", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "summary", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "var", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "del", {
	                    "remove": 1
	                }), _defineProperty(_tags, "blockquote", {
	                    "check_attributes": {
	                        "cite": "url"
	                    }
	                }), _defineProperty(_tags, "style", {
	                    "remove": 1
	                }), _defineProperty(_tags, "device", {
	                    "remove": 1
	                }), _defineProperty(_tags, "meter", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "h3", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "textarea", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "embed", {
	                    "remove": 1
	                }), _defineProperty(_tags, "hgroup", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "font", {
	                    "rename_tag": "span",
	                    "add_class": {
	                        "size": "size_font"
	                    }
	                }), _defineProperty(_tags, "tt", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "noembed", {
	                    "remove": 1
	                }), _defineProperty(_tags, "thead", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "blink", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "plaintext", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "xml", {
	                    "remove": 1
	                }), _defineProperty(_tags, "h6", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "param", {
	                    "remove": 1
	                }), _defineProperty(_tags, "th", {
	                    "check_attributes": {
	                        "rowspan": "numbers",
	                        "colspan": "numbers"
	                    },
	                ...
	                }), _defineProperty(_tags, "legend", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "hr", {}), _defineProperty(_tags, "label", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "dl", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "kbd", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "listing", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "dt", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "nextid", {
	                    "remove": 1
	                }), _defineProperty(_tags, "pre", {}), _defineProperty(_tags, "center", {
	                    "rename_tag": "div",
	                    "set_class": "wysiwyg-text-align-center"
	                }), _defineProperty(_tags, "audio", {
	                    "remove": 1
	                }), _defineProperty(_tags, "datalist", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "samp", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "col", {
	                    "remove": 1
	                }), _defineProperty(_tags, "article", {
	                    "rename_tag": "div"
	                }), _defineProperty(_tags, "cite", {}), _defineProperty(_tags, "link", {
	                    "remove": 1
	                }), _defineProperty(_tags, "script", {
	                    "remove": 1
	                }), _defineProperty(_tags, "bdo", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "menu", {
	                    "rename_tag": "ul"
	                }), _defineProperty(_tags, "colgroup", {
	                    "remove": 1
	                }), _defineProperty(_tags, "ruby", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "h2", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "ins", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "p", {
	                    "add_class": {
	                        "align": "align_text"
	                    }
	                }), _defineProperty(_tags, "sub", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "comment", {
	                    "remove": 1
	                }), _defineProperty(_tags, "frameset", {
	                    "remove": 1
	                }), _defineProperty(_tags, "optgroup", {
	                    "rename_tag": "span"
	                }), _defineProperty(_tags, "header", {
	                    "rename_tag": "div"
	                }), _tags)
	            }
	        });
	    ...
	    vm.initializeCommentData = function () {
	        vm.comment = {
	            user: '',
	            comment: ''
	        };
	    ...
	    vm.deleteComment = function () {
	        if (vm.comment.id) {
	            CommentSvc.delete(vm.comment, function (reponse) {
	                vm.initializeCommentData();
	                vm.getCommentList();
	            });
	        }
	    ...
	    vm.getCommentList = function () {
	        if (!vm.key) return false;
	
	        CommentSvc.query({ key: vm.key }, function (response) {
	            vm.listComplete = response.results.list;
	            vm.list = vm.listComplete.slice(0, 3);
	        });
	    };
	
	    vm.verMasComentarios = function () {
	        vm.listLimit += 3;
...
/***/ function(module, exports) {
	...
	module.exports = "<!--<div class=\"col-sm-12\" ng-if=\"!$ctrl.key\">\n   <div class=\"callout callout-info\">\n        * Por favor seleccione un Punto para ver los comentarios\n   </div clas>\n</div>-->\n\n<div class=\"col-sm-12\" ng-if=\"$ctrl.key\">\n    <h4>{{$ctrl.title}}</h4>\n    <button class=\"btn btn-primary btn-block margin-bottom\" \n            style=\"max-width: 300px;\"\n            ng-click=\"$ctrl.showCommentForm()\">Agregar Comentario</button>\n</div>\n\n<div class=\"col-sm-12 comment-group \" ng-if=\"$ctrl.key\">\n    <div ng-if=\"$ctrl.list.length < 1\">\n        * Aun no hay comentarios registrados.\n    </div>\n    <div ng-repeat=\"comment in $ctrl.list track by $index\" class=\"comment-item\">\n        <a type=\"button\" \n            ng-if=\"!$ctrl.isViewMode\"\n            class=\"btn comment-edit\"\n            title=\"Editar\"\n            ng-click=\"$ctrl.editComment(comment)\">\n                <i class=\"fa fa-edit\"></i> \n        </a>\n\n        <div class=\"comment-post\">\n            <div class=\"user-block\" ng-if=\"!$ctrl.isViewMode\">\n                \n                <span class=\"username\"> <a>{{comment.USUARIO}}</a> </span>\n                <span class=\"date \">{{comment.CREATED_AT}}</span> \n            </div>\n            <div class=\"comment-body\" ng-bind-html=\"comment.COMENTARIO\">\n            \n            </div>\n            \n        </div>\n    </div>\n    <div class=\"ver-mas\">\n        <button class=\"btn btn-info\" ng-click=\"$ctrl.verMasComentarios()\">Ver mas </button>\n    </div>\n</div>\n<div class=\"modal fade\"\n     id=\"addComment-key-{{$ctrl.key}}\"\n     tabindex=\"-1\"\n     role=\"dialog\"\n     aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n            <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                <h2 class=\"modal-title\" id=\"myModalLabel\">{{$ctrl.title}}</h2>\n                <h4 class=\"modal-title\" id=\"myModalLabel\">Agregar comentario</h4>\n                \n            </div>\n            <div class=\"modal-body\">\n                <div class=\"form-group\">\n                 <form>\n                    <!-- <a ng-click=\"$ctrl.mostrarEditor()\">Mostar editor</a> -->\n                        <input type=\"text\" class=\"form-control\" placeholder=\"Usuario\" ng-model=\"$ctrl.comment.user\" required>\n\n\n<div id=\"toolbar\" style=\"display: none;\">\n    <a data-wysihtml5-command=\"bold\" title=\"CTRL+B\">Bold</a> |\n    <a data-wysihtml5-command=\"italic\" title=\"CTRL+I\">Italic</a> |\n    <a data-wysihtml5-command=\"underline\">underline</a> |\n    <a data-wysihtml5-command=\"createLink\">Insertar link</a> |\n    \n    <a data-wysihtml5-command=\"formatBlock\" data-wysihtml5-command-value=\"h1\">h1</a> |\n    <a data-wysihtml5-command=\"formatBlock\" data-wysihtml5-command-value=\"h2\">h2</a> |\n    <a data-wysihtml5-command=\"insertUnorderedList\">Lista con bullet</a> |\n    <a data-wysihtml5-command=\"insertOrderedList\">Lista numerica</a> |\n    \n    <a data-wysihtml5-command=\"undo\">atras</a> |\n    <a data-wysihtml5-command=\"redo\">Adelante</a> |\n    \n    <a data-wysihtml5-action=\"change_view\">Ver Html</a>\n    \n    <div data-wysihtml5-dialog=\"createLink\" style=\"display: none;\">\n      <label>\n        Link:\n        <input data-wysihtml5-dialog-field=\"href\" value=\"http://\">\n      </label>\n      <a data-wysihtml5-dialog-action=\"save\">OK</a>&nbsp;<a data-wysihtml5-dialog-action=\"cancel\">Cancel</a>\n    </div>\n    \n  </div>\n\n\n\n\n                        <textarea \n                                    id=\"text-editor\" \n                                    class=\"form-control text-editor\" \n                                    rows=\"3\" placeholder=\"Comentario ...\" \n                                    ng-model=\"$ctrl.comment.comment\" required>\n                            \n                        </textarea>\n                 </form>\n                </div>\n            </div>\n            <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-danger pull-left\" data-dismiss=\"modal\" ng-click=\"$ctrl.deleteComment()\" ng-if=\"$ctrl.comment.id\">Borrar</button>\n                <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Cancelar</button>\n                <button type=\"button\"\n                        class=\"btn btn-info\"\n                        ng-click=\"$ctrl.saveComment()\"\n                        data-dismiss=\"modal\">\n                    Guardar\n                </button>\n            </div>\n        </div>\n    </div>\n</div>"
...
/***/ function(module, exports) {
	...
	angular.module('doc.features').factory('CommentSvc', ['$resource', 'ServicesConfig', function ($resource, ServicesConfig) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function Controller(CommentSvc) {
	    var vm = this;
	    vm.list = [];
	    vm.comment = {
	        user: '',
	    ...
	    vm.saveComment = function () {
	        ...
	        vm.comment.key = vm.key;
	        if (vm.comment.id) {
	            CommentSvc.update(vm.comment, function (reponse) {
	                vm.comment = { user: '', comment: '' };
	                vm.getCommentList();
	            });
	        } else {
	            CommentSvc.save(vm.comment, function (response) {
	                vm.comment = { user: '', comment: '' };
	                vm.getCommentList();
	            });
	        }
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"modal fade\"\n     id=\"comment-popup-form\"\n     tabindex=\"-2\"\n     role=\"dialog\"\n     aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n            <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                <h4 class=\"modal-title\" id=\"myModalLabel\">{{$ctrl.title}}</h4>\n                \n            </div>\n            <div class=\"modal-body\">\n                <div class=\"form-group\">\n                 <form>\n                    <input type=\"text\" class=\"form-control\" placeholder=\"Usuario\" ng-model=\"$ctrl.comment.user\" required>\n                     <textarea class=\"form-control\" rows=\"3\" placeholder=\"Comentario ...\" ng-model=\"$ctrl.comment.comment\" required></textarea>\n                 </form>\n                </div>\n                <div class=\"form-group pull-right\">\n                    <button type=\"button\" \n                            class=\"btn btn-danger pull-left\" \n                            ng-click=\"$ctrl.deleteComment()\" \n                            ng-if=\"$ctrl.comment.id\">Borrar</button>\n                    <button type=\"button\"\n                            class=\"btn btn-info\"\n                            ng-click=\"$ctrl.saveComment()\">\n                        Guardar\n                    </button>\n                </div>\n\n                <div class=\"col-sm-12\">\n                    <image-list-component key=\"$ctrl.key\"></image-list-component>\n                </div>\n\n                <div class=\"col-sm-12 comment-group \" ng-if=\"$ctrl.key\">\n                    <div ng-if=\"$ctrl.list.length < 1\">\n                        * Aun no hay comentarios registrados.\n                    </div>\n                    <div ng-repeat=\"comment in $ctrl.list\" class=\"comment-item\">\n                        <a type=\"button\" \n                            ng-if=\"!$ctrl.isViewMode\"\n                            class=\"btn comment-edit\"\n                            title=\"Editar\"\n                            ng-click=\"$ctrl.editComment(comment)\">\n                                <i class=\"fa fa-edit\"></i> \n                        </a>\n\n                        <div class=\"comment-post\">\n                            <div class=\"user-block\" ng-if=\"!$ctrl.isViewMode\">\n                                \n                                <span class=\"username\"> <a>{{comment.USUARIO}}</a> </span>\n                                <span class=\"date \">{{comment.CREATED_AT}}</span> \n                            </div>\n                            <div class=\"comment-body\">\n                            {{comment.COMENTARIO}}\n                            </div clas>\n                            \n                        </div>\n                    </div>\n                </div>\n            </div>\n            </div>\n        </div>\n    </div>\n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function Controller() {
	    var vm = this;
	    vm.selectContent = function (content, event, el) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div ng-if=\"$ctrl.contents.length > 0\" class=\"box-body no-padding\">\n    <ul class=\"nav nav-pills nav-stacked\">\n        <li class=\"content-click {{content.CONTENT_TYPE}}\"  data-id=\"{{content.ID}}\" ng-repeat=\"content in $ctrl.contents\" ng-click=\"$ctrl.selectContent(content, event)\">\n            <a style=\"font-weight: bold;\">\n                &nbsp; &nbsp; &nbsp; &nbsp;<i class=\"fa fa-fw \" ng-class=\"{'fa-table': content.CONTENT_TYPE == 'tabla','fa-area-chart': content.CONTENT_TYPE == 'grafico'}\"></i> {{content.NAME}}\n            </a>\n        </li>\n    </ul>\n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GeneradorCtrl = function GeneradorCtrl(ReportesSvc, GeneradorSvc) {
	    var vm = this;
	    vm.isLoading = false;
	    vm.filtros = {
	        year: 0,
	    ...
	    vm.getYearList = function () {
	        for (var i = moment().format('YYYY') * 1; i > 2005; i--) {
	            vm.yearList.push(i);
	        }
	    };
	    vm.getWeeksList = function () {
	        for (var i = 1; i < 53; i++) {
	    ...
	    ReportesSvc.query(function (response) {
	        return vm.reports = response.results.list;
	    });
	    vm.selectContent = function (content) {
	    ...
	    vm.generateGraphicsFromContent = function () {
	        ...
	        vm.isLoading = true;
	        vm.graphicTable = '';
	        GeneradorSvc.get(vm.filtros, function (response) {
	            vm.graphics = response.results.graphics;
...
/***/ function(module, exports) {
	...
	angular.module('doc.features').factory('GeneradorSvc', ['$resource', 'ServicesConfig', function ($resource, ServicesConfig) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function Controller($scope) {
	    ...
	    switch (vm.mainGrapicType) {
	      ...
	      case 'line':
	        ...
	        vm.chartConfig.xAxis = {
	          categories: _.uniq(_.map(vm.data, function (item) {
	            return item.REFFECHA;
	          }))
	        };
	
	        vm.chartConfig.yAxis = vm.graphic.kpis.map(function (kpi, index) {
	          // console.log('kpi', kpi);
	          return {
	        ...
	        vm.graphic.kpis.forEach(function (kpi) {
	          var campo = kpi.NAME_FROM_PROCEDURE;
	          // Get series
	          elementos.forEach(function (el) {
	            var data = elementosData[el].map(function (item) {
	              return item[kpi.NAME_FROM_PROCEDURE] * 1;
	            });
	            if (data.length != totalColumns) {
	              // LLenar columnas
	              data = [];
	              vm.chartConfig.xAxis.categories.forEach(function (xAxis) {
	                var value = elementosData[el].find(function (item) {
	                  return item.REFFECHA === xAxis;
	                });
	                if (value) {
	  ...
	  vm.currentPoint = '';
	  vm.onPointClick = function (key, title) {
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"col-sm-12\">\n    <!--<highchart ng-if=\"!$ctrl.isLoading\" id=\"{{$ctrl.charId}}\" config=\"$ctrl.chartConfig\"></highchart>-->\n    <hc-chart options=\"$ctrl.chartConfig\" id=\"{{$ctrl.charId}}\" ng-if=\"!$ctrl.isLoading\"></hc-chart>\n</div>\n<!-- <div class=\"col-sm-4 comment-small-block\" ng-if=\"!$ctrl.hideComments\">\n    <comment-block-component key=\"$ctrl.currentPoint\"\n                             title=\"{{$ctrl.pointTitle}}\"></comment-component>\n</div> -->\n<div class=\"col-sm-12 graphic-table-wrapper\" ng-bind-html=\"$ctrl.graphictable\"></div>\n\n<div class=\"col-sm-12 comment-long-block\" ng-if=\"!$ctrl.hideComments\">\n    <comment-block-component key=\"$ctrl.graphic.id\" title=\"Comentarios generales\"></comment-component>\n</div>\n\n<div class=\"col-sm-12\">\n    <image-list-component ng-if=\"$ctrl.semanaImageList\" key=\"$ctrl.semanaImageList\"></image-list-component>\n</div>\n\n<comment-popup-component ng-if=\"$ctrl.showCommentPopup\"\n                         key=\"$ctrl.currentPoint\" \n                         title=\"{{$ctrl.pointTitle}}\"></comment-popup-component>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function Controller(CommentSvc, Upload, $timeout, Lightbox) {
	    var vm = this;
	    ...
	    vm.$onInit = function () {
	        ...
	        var _vm$key$split = vm.key.split("-"),
	            _vm$key$split2 = _slicedToArray(_vm$key$split, 2),
	            year = _vm$key$split2[0],
	            week = _vm$key$split2[1];
	    ...
	    vm.$onChanges = function (data) {
	        ...
	        var _vm$key$split3 = vm.key.split("-"),
	            _vm$key$split4 = _slicedToArray(_vm$key$split3, 2),
	            year = _vm$key$split4[0],
	            week = _vm$key$split4[1];
	
	        vm.title = 'Semana ' + year + ' - ' + week;
	    };
	
	    vm.getImagesList = function () {
	        CommentSvc.getFilesByKey({ key: vm.key }, function (response) {
	    ...
	    vm.removeFile = function (item) {
	        CommentSvc.removeFile({ id: item.ID }, function (response) {
	            vm.getImagesList();
	        });
	    };
	    vm.temporaldata = {};
	    vm.showEditFileDialog = function (item) {
	        vm.temporaldata = item;
	        angular.element('#confirm-dialog').modal();
	    };
	    vm.updateFile = function (_ref) {
	        var ID = _ref.ID,
	            NAME = _ref.NAME;
	
	
	        CommentSvc.updateFile({ name: NAME, id: ID }, function (response) {
	            vm.getImagesList();
	        });
	    };
	};
...
/***/ function(module, exports) {
	...
	module.exports = "<br>    \n<hr>\n<div class=\"upload-image\">\n    <label for=\"\"><b>Imagenes de la {{$ctrl.title}} : </b> </label>\n    <button type=\"file\" ngf-select=\"$ctrl.uploadFiles($file, $invalidFiles)\"\n        accept=\"image/*\">\n     Subir imagen </button>\n</div>\n<div class=\"image-list-wrap\">\n    \n    <div class=\"image-item\" ng-repeat=\"item in $ctrl.imageList\">\n        <img ng-src=\"{{item.url}}\" \n             width=\"100px\" \n             ng-click=\"$ctrl.openLightboxModal($index)\"/>\n        \n        <a ng-click=\"$ctrl.showEditFileDialog(item)\">\n            <span class=\"image-name\">{{item.NAME}}</span>\n            <i class=\"fa fa-fw fa-remove\"></i>\n        </a>\n    </div>\n\n</div>\n<br>    \n<hr>\n<br>\n\n\n\n<div class=\"modal fade\"\n     id=\"confirm-dialog\"\n     tabindex=\"-1\"\n     role=\"dialog\"\n     style=\"z-index: 1080 !important\"\n     aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n            <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                <h4 class=\"modal-title\" id=\"myModalLabel\">Edicion: </h4>\n            </div>\n            <div class=\"modal-body\">\n               Nombre : <input type=\"text\" name=\"imageName\" class=\"form-control\" ng-model=\"$ctrl.temporaldata.NAME\">\n            </div>\n            <div class=\"modal-footer\">\n                <button type=\"button\" \n                        class=\"btn btn-default\" \n                        ng-click=\"$ctrl.getImagesList()\"\n                        data-dismiss=\"modal\">Cancelar</button>\n                <button type=\"button\"\n                        class=\"btn btn-danger\"\n                        ng-click=\"$ctrl.removeFile($ctrl.temporaldata)\"\n                        data-dismiss=\"modal\">\n                    Eliminar\n                </button>\n                <button type=\"button\"\n                        class=\"btn btn-primary\"\n                        ng-click=\"$ctrl.updateFile($ctrl.temporaldata)\"\n                        data-dismiss=\"modal\">\n                    Guardar\n                </button>\n            </div>\n        </div>\n    </div>\n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Controller = function Controller(GeneradorSvc) {
	    var vm = this;
	
	    GeneradorSvc.getReportsMenu(function (response) {
	        vm.data = response.results.list;
	    });
	    vm.onSelectContent = function (content) {
	        vm.onClick({ content: content });
	    };
	};
...
/***/ function(module, exports) {
	...
	module.exports = "<div ng-repeat=\"report in $ctrl.data\">\n    <div class=\"box-header with-border\">\n        <h3 class=\"box-title\"> <i class=\"fa fa-fw fa-minus-square-o\"></i> {{report.name}}</h3>\n    </div>\n    <contents-link-component contents=\"report.contents\" on-click=\"$ctrl.onSelectContent(content)\"></contents-link-component>\n    <div ng-if=\"report.subreports.length > 0\" >\n        <div class=\"box-body no-padding\">\n            <ul class=\"nav nav-pills nav-stacked\">\n                <li ng-repeat=\"subreport in report.subreports\">\n                    <a >  <i class=\"fa fa-fw  fa-minus-square-o\"></i> {{subreport.NAME}} </a>\n                    <contents-link-component contents=\"subreport.contents\"\n                                             on-click=\"$ctrl.onSelectContent(content)\"></contents-link-component>    \n                </li>\n            </ul>\n        </div>\n    </div>\n</div>"
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"tabla-graphic\">\n    {{\n        $ctrl.data\n    }}\n</div>\n<div class=\"col-sm-12 comment-long-block\" ng-if=\"!$ctrl.loading\">\n    <comment-block-component key=\"$ctrl.charId\" title=\"Comentarios\"></comment-component> \n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	function ReportesFormComponentCtrl($filter, $location, $routeParams, ReportesSvc, notification) {
	  ...
	  vm.temporaldata = {};
	  vm.showRemoveConfirmDialog = function (index, item) {
	...
	angular.module('doc.features').component('reportesFormComponent', {
	  ...
	  controller: ['$filter', '$location', '$routeParams', 'ReportesSvc', 'notification', ReportesFormComponentCtrl],
	  bindings: {}
	});
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"content row\">\n    <div class=\"col-md-12\">\n        <div class=\"box box-info\">\n            <div class=\"box-header with-border\"\n                 ng-switch=\"!!$ctrl.reporte.ID\">\n                <h3 class=\"box-title\"\n                    ng-switch-when=\"false\">Creación de Reportes</h3>\n                <h3 class=\"box-title\"\n                    ng-switch-when=\"true\">Edición de Reportes</h3>\n            </div>\n            <form class=\"form-horizontal\" name=\"form\" validate>\n                <div class=\"box-body\">\n                   \n                    <div class=\"form-group\">\n                        <label for=\"descripcion\"\n                               class=\"col-sm-2 control-label\"\n                               required-field>Nombre: </label>\n                        <div class=\"col-sm-10\">\n                            <input type=\"text\" class=\"form-control\" id=\"descripcion\" placeholder=\"Nombre\"\n                                   required\n                                   maxlength=\"500\"\n                                   ng-model=\"$ctrl.reporte.NAME\"\n                                   data-auto-focus>\n                        </div>\n                    </div>\n                    <div class=\"form-group\">\n                        <label for=\"descripcion\"\n                               class=\"col-sm-2 control-label\">Sub Reportes: </label>\n                        <div class=\"col-sm-10\">\n                            <div class=\"row \">\n                                <div class=\"col-sm-12 subreports-item\" ng-repeat=\"item in $ctrl.reporte.sub track by $index\">\n                                    <div class=\"col-sm-6\">\n                                        <input type=\"text\" class=\"form-control\" required ng-model=\"item.NAME\" placeholder=\"SUB reporte ...\">\n                                    </div>\n                                    <div class=\"col-sm-6\"> \n                                        <a  ng-click=\"$ctrl.showRemoveConfirmDialog($index, item)\"> <i class=\"fa fa-trash\"></i></a>\n                                    </div>\n                                </div>  \n                            </div>\n                            <div class=\"col-sm-3\">\n                                 <a class=\"btn btn-block btn-success btn-sm\"  ng-click=\"$ctrl.addSubReport()\">Agregar Sub Reporte</a>\n                            </div>\n                        </div>\n                    </div>\n                    \n                </div>\n                <div class=\"box-footer\">\n                    <button type=\"submit\" class=\"btn btn-info pull-right\" ng-click=\"$ctrl.save(form)\">Guardar</button>\n                    <button type=\"submit\" class=\"btn btn-default\" ng-click=\"$ctrl.backToList()\">Cancelar</button>\n                </div>\n            </form>\n        </div>\n    </div>\n</div>\n\n<div class=\"modal fade\"\n     id=\"confirm-dialog\"\n     tabindex=\"-1\"\n     role=\"dialog\"\n     aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n            <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                <h4 class=\"modal-title\" id=\"myModalLabel\">Confirmar</h4>\n            </div>\n            <div class=\"modal-body\">\n                Seguro que desea eliminar el sub reporte: {{ $ctrl.temporaldata.name }}\n            </div>\n            <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-primary\" data-dismiss=\"modal\">Cancelar</button>\n                <button type=\"button\"\n                        class=\"btn btn-danger\"\n                        ng-click=\"$ctrl.removeSubReport($ctrl.temporaldata.index)\"\n                        data-dismiss=\"modal\">\n                    Eliminar\n                </button>\n            </div>\n        </div>\n    </div>\n</div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReportesComponentCtrl = function ReportesComponentCtrl(notification, ServicesConfig, ReportesSvc) {
	    var vm = this;
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"content-header\">\n    <h1>Gestión de Reportes</h1>\n</div>\n<div class=\"content\">\n    <div class=\"row\">\n        <div class=\"col-sm-4\">\n            <div class=\"text-left\">\n                <a href=\"#/reportes/create\" type=\"button\" class=\"btn btn-primary\">\n                    <i class=\"fa fa-plus-circle\"></i>\n                    Crear Reporte\n                </a>\n            </div>\n        </div>\n    </div>\n    <div class=\"panel panel-default\">\n        <div class=\"panel-heading\">\n            <div class=\"row\">\n                <div class=\"col-sm-4\">\n                    <div class=\"input-group\">\n                        <input type=\"text\"\n                               class=\"form-control\"\n                               placeholder=\"Buscar\"\n                               data-enter-press=\"$ctrl.search()\"\n                               ng-model=\"$ctrl.searchKey\">\n                        <span class=\"input-group-addon\"\n                              ng-click=\"$ctrl.search()\">\n                            <i class=\"glyphicon glyphicon-search\"></i>\n                        </span>\n                    </div>\n                </div>\n            </div>\n        </div>\n        <div class=\"panel-body\">\n            <ad-table-ajax table-name=\"clientes\"\n                           column-definition=\"$ctrl.colDef\"\n                           table-classes=\"table table-bordered table-hover bg-blank\"\n                           page-sizes=\"[10, 25, 100]\"\n                           page-size=\"10\"\n                           pagination-btn-group-classes=\"pagination pagination-sm\"\n                           ajax-config=\"$ctrl.tableConfig\"\n                           page-loader=\"methods.pageLoader\"\n                           state=\"$ctrl.tableConfig.state\"\n                           items-not-found-message=\"No se encontraron datos\">\n            </ad-table-ajax>\n        </div>\n    </div>\n</div>\n\n<div class=\"modal fade\"\n     id=\"deleteModal\"\n     tabindex=\"-1\"\n     role=\"dialog\"\n     aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n        <div class=\"modal-content\">\n            <div class=\"modal-header\">\n                <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                <h4 class=\"modal-title\" id=\"myModalLabel\">Confirmar eliminación</h4>\n            </div>\n            <div class=\"modal-body\">\n                Seguro que desea eliminar el REPORTE: {{ $ctrl.toDelete.NAME }}\n            </div>\n            <div class=\"modal-footer\">\n                <button type=\"button\" class=\"btn btn-primary\" data-dismiss=\"modal\">Cancelar</button>\n                <button type=\"button\"\n                        class=\"btn btn-danger\"\n                        ng-click=\"$ctrl.delete($ctrl.toDelete.ID)\"\n                        data-dismiss=\"modal\">\n                    Eliminar\n                </button>\n            </div>\n        </div>\n    </div>\n</div>\n"
...
/***/ function(module, exports) {
	...
	angular.module('doc.features').factory('ReportesSvc', ['$resource', 'ServicesConfig', function ($resource, ServicesConfig) {
...
/***/ function(module, exports) {
	...
	(function () {
	  angular.module('doc.features').config(['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
	    $locationProvider.html5Mode(false).hashPrefix('');
	    $routeProvider.when('/', { template: "<reportes-component></reportes-component>" }).when('/reportes', { template: "<reportes-component></reportes-component>" }).when('/reportes/create', { template: "<reportes-form-component></reportes-form-component>" }).when('/reportes/:id', { template: "<reportes-form-component></reportes-form-component>" }).when('/contenidos', { template: "<content-list-component></content-list-component>" }).when('/contenidos/create', { template: "<content-component></content-component>" }).when('/contenidos/:id', { template: "<content-component></content-component>" }).when('/generador', { template: "<generador-component></generador-component>" }).when('/comentarios', { template: "<comments-component></comments-component>" }).when('/exportador', { template: "<exportador-component></exportador-component>" });
	  }]);
	})();
